...
class DeleteLocationUseCase @Inject constructor(private val myLocationsRepository: MyLocationsRepository) {

    suspend operator fun invoke(
        addLocationRequest: AddLocationRequest,
        dispatcher: CoroutineDispatcher
    ) = withContext(dispatcher) {
        myLocationsRepository.deleteLocation(addLocationRequest)
    }
}